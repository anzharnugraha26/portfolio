...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ asset('front-master/assets/vendor/aos/aos.css') }}" rel="stylesheet">
    <link href="{{ asset('front-master/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('front-master/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('front-master/assets/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
    <link href="{{ asset('front-master/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
    <link href="{{ asset('front-master/assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href="{{ asset('front-master/assets/css/style.css') }}" rel="stylesheet">
...
<body>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center">
        <div class="container" data-aos="zoom-in" data-aos-delay="100">
            ...
            <p>I'm <span class="typed" data-typed-items="Web Developer, PHP Developer, Freelancer"></span></p>
    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <img src="{{ asset('image/b1.png') }}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="resume-item">
                            <h4>Programmer</h4>
                            <h5>2019 - 2020</h5>
                            <p><em>PT Komitras, Cinere Depok, Jawa Barat</em></p>
                            <ul>
        ...
        <section id="portfolio" class="portfolio section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('portfolio/5.jpg') }}" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>Jokes Bapack2 By Html Css Javascript</h4>
                                <p>Web</p>
                                <div class="portfolio-links">
                                    {{-- <a href="assets/img/portfolio/portfolio-9.jpg" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a> --}}
                                    <a href="{{ url('jokes-bapack-bapack') }}"  title="Portfolio Details" target="_blank"><i
                                            class="bx bx-link"></i></a>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('front-master/assets/vendor/purecounter/purecounter.js') }}"></script>
    <script src="{{ asset('front-master/assets/vendor/aos/aos.js') }}"></script>
    <script src="{{ asset('front-master/assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('front-master/assets/vendor/glightbox/js/glightbox.min.js') }}"></script>
    <script src="{{ asset('front-master/assets/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('front-master/assets/vendor/swiper/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('front-master/assets/vendor/typed.js/typed.min.js') }}"></script>
    <script src="{{ asset('front-master/assets/vendor/waypoints/noframework.waypoints.js') }}"></script>
    <script src="{{ asset('front-master/assets/vendor/php-email-form/validate.js') }}"></script>

    <!-- Template Main JS File -->
    <script src="{{ asset('front-master/assets/js/main.js') }}"></script>
