...
<head>
	...
	<link rel="stylesheet" href="{{asset('tinggaljualan-master/front-master/css/bootstrap.css')}}">
	<link rel="stylesheet" href="{{asset('tinggaljualan-master/front-master/vendors/linericon/style.css')}}">
	<link rel="stylesheet" href="{{asset('tinggaljualan-master/front-master/css/font-awesome.min.css')}}">
	<link rel="stylesheet" href="{{asset('tinggaljualan-master/front-master/vendors/owl-carousel/owl.carousel.min.css')}}">
	<link rel="stylesheet" href="{{asset('tinggaljualan-master/front-master/css/magnific-popup.css')}}">
	<link rel="stylesheet" href="{{asset('tinggaljualan-master/front-master/vendors/nice-select/css/nice-select.css')}}">

	<!-- CSS only -->
	<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-eOJMYsd53ii+scO/bJGFsiCZc+5NDVN2yr8+0RDqr0Ql0h+rP48ckxlpbzKgwra6" crossorigin="anonymous">
	
	<!-- main css -->
	<link rel="stylesheet" href="{{asset('tinggaljualan-master/front-master/css/style.css')}}">
...
<body>
	...
	<script src="{{asset('tinggaljualan-master/front-master/js/jquery-3.2.1.min.js')}}"></script>
	<script src="{{asset('tinggaljualan-master/front-master/js/popper.js')}}"></script>
	<script src="{{asset('tinggaljualan-master/front-master/js/bootstrap.min.js')}}"></script>
	<script src="{{asset('tinggaljualan-master/front-master/js/stellar.js')}}"></script>
	<script src="{{asset('tinggaljualan-master/front-master/js/jquery.magnific-popup.min.js')}}"></script>
	<script src="{{asset('tinggaljualan-master/front-master/vendors/nice-select/js/jquery.nice-select.min.js')}}"></script>
	<script src="{{asset('tinggaljualan-master/front-master/vendors/isotope/imagesloaded.pkgd.min.js')}}"></script>
	<script src="{{asset('tinggaljualan-master/front-master/vendors/isotope/isotope-min.js')}}"></script>
	<script src="{{asset('tinggaljualan-master/front-master/vendors/owl-carousel/owl.carousel.min.js')}}"></script>
	<script src="{{asset('tinggaljualan-master/front-master/js/jquery.ajaxchimp.min.js')}}"></script>
	<script src="{{asset('tinggaljualan-master/front-master/js/mail-script.js')}}"></script>
	<!--gmaps Js-->

	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
	<script src="{{asset('tinggaljualan-master/front-master/js/gmaps.min.js')}}"></script>
	<script src="{{asset('tinggaljualan-master/front-master/js/theme.js')}}"></script>
